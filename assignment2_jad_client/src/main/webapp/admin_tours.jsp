...
<body>
				...
				<tbody>
						...
						<div class="modal-content" role="document">
							...
							<div class="modal-footer u-text-right">
								<a href="#components" class="u-inline-block">
									...
									<form action="/assignment1_jad/TourDeleteController"
										method="post">
					...
					<div class="modal --lg" id="update-<%=i.getTourid()%>-modal">
						...
						<div class="modal-content" role="document">
							...
							<form action="/assignment1_jad/TourUpdateController"
								method="post">
								<div class="modal-body">
	...
	<div class="modal" id="delete-category-modal">
		...
		<div class="modal-content" role="document">
			...
			<form action="/assignment1_jad/CategoryDeleteController"
				method="post">
				<div class="modal-body">
					...
					for (Category i : displayCategory) {
					%>
					<input type="radio" name="delete_category"
						value="<%=i.getCatID()%>"><%=i.getCategoryName()%><br>
					<%
					}
					%>
		...
		<div class="modal-content" role="document">
			...
			<form>
				<div class="modal-body" style="width:500px">
					<input type="radio" name="tourfilter" id="popularity" value="popularity"><label for="popularity" onclick="removeSlotsInput()">By popularity</label><br> 
					<input type="radio" name="tourfilter" id="create" value="create"><label for="create" onclick="removeSlotsInput()">By time created</label><br> 
					<input type="radio" name="tourfilter" id="zerosales" value="zerosales"><label for="zerosales" onclick="removeSlotsInput()">By Zero Sales</label><br> 
					<input type="radio" name="tourfilter" id="slots" value="slots" onclick="slotsInput()"><label for="slots">By slots</label><br>
	...
	<script>
		function slotsInput(){
			var new_input = "<label for='slotsInput'>Enter slots</label><br><input type='text' name='slotsInput' id='slotsInput' oninput='validateInput()'><div id='errMsg' style='color:red'></div>";
			$('#inputField').append(new_input);
		}
		function removeSlotsInput(){
			document.getElementById("inputField").innerHTML = "";
		}
		function validateInput(){
			var slotsInput = parseInt(document.getElementById("slotsInput").value);
			if(isNaN(slotsInput)){
				document.getElementById("errMsg").innerHTML = "Please enter numbers only!";
			}
			else{
